    ...
    try {
      ...
      const issuer = await prisma.issuer.create({
        data: {
          ...
          email: body.email,
          phone: body.phone,
          directors: body.directors || undefined,
          beneficialOwners: body.beneficialOwners || undefined,
          keyPersons: body.keyPersons || undefined,
          regulatoryStatus: body.regulatoryStatus,
          licenses: body.licenses || undefined,
