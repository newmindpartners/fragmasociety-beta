...
export const Hero = () => {
  ...
  return <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        {/* Loading skeleton */}
        <AnimatePresence>
          {!videoLoaded && <motion.div initial={{
          opacity: 1
        }} exit={{
          opacity: 0
        }} transition={{
          duration: 0.8
              ...
              <div className="absolute inset-0 overflow-hidden">
                <motion.div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -skew-x-12" animate={{
              x: ["-100%", "200%"]
            }} transition={{
              duration: 2,
              repeat: Infinity,
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <motion.div className="w-16 h-16 rounded-full border-2 border-primary/30 border-t-primary" animate={{
              rotate: 360
            }} transition={{
              duration: 1,
              repeat: Infinity,
        ...
        <video autoPlay muted loop playsInline onLoadedData={() => setVideoLoaded(true)} className={`w-full h-full object-cover transition-opacity duration-700 ${videoLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className="container mx-auto px-6 relative z-10 pt-32 pb-20">
        ...
        duration: 0.8
          ...
          <h1 className="text-5xl lg:text-7xl xl:text-8xl font-serif font-bold text-white leading-tight mb-4">Buy and sell</h1>
          ...
          delay: 0.8
            ...
            {dynamicWords.map((_, index) => <motion.div key={index} className={`h-1 rounded-full transition-all duration-500 ${index === currentWordIndex ? "w-8 bg-white" : "w-2 bg-white/20"}`} />)}
          </motion.div>
          ...
          <div className="flex flex-col md:flex-row justify-center items-stretch gap-6 md:gap-8 max-w-3xl mx-auto">
            ...
            ease: [0.16, 1, 0.3, 1]
                ...
                <div className="relative h-full p-8 text-center">
                  ...
                  <motion.div className="absolute inset-0 rounded-2xl bg-primary/[0.03] opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                  
                  {/* Icon container */}
                  <motion.div className="relative inline-flex items-center justify-center w-14 h-14 mb-5" whileHover={{
                scale: 1.05
              }} transition={{
                duration: 0.4,
                ease: [0.16, 1, 0.3, 1]
                  ...
                  {/* Icon ring */}
                    ...
                    <motion.div className="absolute inset-[-2px] rounded-full border border-transparent border-t-white/50" animate={{
                  rotate: 360
                }} transition={{
                  duration: 8,
                  repeat: Infinity,
                  ...
                  opacity: 1
                    ...
                    <item.Icon className="text-white/70 group-hover:text-white transition-colors duration-500" size={22} strokeWidth={1.5} />
                  </motion.div>
                  ...
                  <div className="relative mb-2">
                    ...
                    <motion.div className="absolute -bottom-1 left-1/2 h-px bg-gradient-to-r from-transparent via-primary to-transparent" initial={{
                  width: 0,
                  x: "-50%"
                }} whileHover={{
                  width: "60%"
