    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="theme-dashboard sm:max-w-md bg-white border-gray-200 text-gray-900">
        <DialogHeader className="space-y-4">
          ...
          <div>
            <DialogTitle className="text-xl font-semibold text-foreground">Withdraw from Fragma</DialogTitle>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 mt-4">
          ...
          <div className="p-4 rounded-xl border border-border bg-muted/30">
            ...
            <p className="text-lg font-semibold text-foreground">US ${availableBalance.toLocaleString()}.00 Available</p>
          </div>
          ...
          <div className="space-y-2">
            <Label className="text-foreground font-medium">Amount Withdraw</Label>
