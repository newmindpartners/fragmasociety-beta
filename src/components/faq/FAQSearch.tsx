        ...
        >
            ...
            <div className="relative bg-white rounded-2xl border border-slate-200 shadow-lg shadow-slate-100/50 overflow-hidden">
              <div className="relative flex items-center">
                ...
                <Input
                  ...
                  className="pl-14 pr-14 py-5 h-16 text-base bg-transparent border-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-slate-900 placeholder:text-slate-400"
                />
                ...
                <AnimatePresence>
                  {searchQuery && (
                    <motion.button
                      ...
                      className="absolute right-5 p-2 rounded-full bg-slate-100 hover:bg-slate-200 transition-colors"
                    >
          ...
          <AnimatePresence>
            {searchQuery && (
              ...
              >
                {totalResults === 0 ? (
                  <span className="text-slate-500">No results found for "{searchQuery}"</span>
                ) : (
