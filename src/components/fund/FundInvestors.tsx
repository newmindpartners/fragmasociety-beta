...
export const FundInvestors = () => {
  const personas = [
    {
      icon: Users,
      title: "Family Offices & UHNWIs",
      points: [
        "Desire for 8%+ income objectives with upside in high-growth sectors.",
        "Preference for single-vehicle exposure instead of multiple direct mandates.",
        "Ability to invest via holding or family office structures for tax optimisation."
      ]
    },
    {
      icon: Building,
    ...
    },
    {
      ...
      points: [
        "Require compliance-by-design tokenisation infrastructure, robust governance and transparent reporting.",
        "Interested in allocation to SME credit + digital infra + tokenisation through a single, professionally managed structure."
      ]
    }
  ];
