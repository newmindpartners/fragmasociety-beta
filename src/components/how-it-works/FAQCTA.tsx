      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white shadow-lg border border-slate-100 mb-6"
          >
            <HelpCircle className="w-8 h-8 text-[#0BDFE9]" />
          </motion.div>
          ...
          >
            <Link to="/faq">
              <Button
                size="lg"
                className="bg-[#0BDFE9] hover:bg-[#0BDFE9]/90 text-slate-900 font-semibold px-8 py-6 text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 group"
              >
