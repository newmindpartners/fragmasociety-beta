...
export const SafetyTrustSection = () => {
  ...
  return (
    <section ref={ref} className="py-24 relative overflow-hidden bg-background">
      {/* Turquoise spotlight studio effects */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Top center spotlight - main */}
        <div 
          className="absolute top-[-200px] left-1/2 -translate-x-1/2 w-[1000px] h-[800px] rounded-full blur-[180px]"
          style={{ background: 'radial-gradient(circle, rgba(45, 212, 191, 0.4) 0%, rgba(45, 212, 191, 0) 70%)' }}
        />
        {/* Left spotlight */}
        <div 
          className="absolute top-0 left-[-100px] w-[500px] h-[500px] rounded-full blur-[150px]"
          style={{ background: 'radial-gradient(circle, rgba(20, 184, 166, 0.35) 0%, transparent 70%)' }}
        />
        {/* Right spotlight */}
        <div 
          className="absolute top-0 right-[-100px] w-[500px] h-[500px] rounded-full blur-[150px]"
          style={{ background: 'radial-gradient(circle, rgba(20, 184, 166, 0.35) 0%, transparent 70%)' }}
        />
      </div>
