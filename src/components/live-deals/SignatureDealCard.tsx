...
export const SignatureDealCard = ({
  ...
  return (
    <motion.div
      ...
      style={{
        boxShadow: isHovered ? "0 0 40px -10px rgba(255,255,255,0.2)" : "none",
      }}
    >
      ...
      <div className="p-4">
        ...
        {/* Stats row */}
        <div className="grid grid-cols-4 gap-2 mb-4 py-3 border-y border-white/5">
          <div className="text-center">
            <Euro className="w-3 h-3 text-white/70 mx-auto mb-0.5" />
            <p className="text-[10px] text-muted-foreground">From</p>
            <p className="text-xs font-semibold text-foreground">{minTicket}</p>
          </div>
          <div className="text-center">
            <Target className="w-3 h-3 text-white/70 mx-auto mb-0.5" />
