  ...
  return (
    <Card className="p-6 bg-card border-border/50">
      <div className="flex items-center gap-2 mb-6">
        ...
        <InfoTooltip content="View order book depth, your active orders, and recent market transactions" />
      </div>
      ...
      <Tabs defaultValue="orderbook" className="w-full">
        <TabsList className="w-full grid grid-cols-3 bg-muted/30 p-1 rounded-lg">
          <TabsTrigger 
            value="orderbook"
            className="data-[state=active]:bg-card data-[state=active]:shadow-sm rounded-md py-2.5 text-sm font-medium"
          >
            Order Book
          </TabsTrigger>
          <TabsTrigger 
