  ...
  const cards = [
    {
      icon: Target,
      title: "Instrument",
      subtitle: "Fragma Performance Note",
      description: "Luxembourg securitisation vehicle; all investors share the same risk–return profile and alignment with the Manager."
    },
    {
      icon: Users,
      title: "Designed For",
      subtitle: "Qualified Investors",
      description: "For investors seeking income-focused strategies with growth potential in digital infrastructure and real-world assets."
    },
    {
      icon: Shield,
      title: "Profile",
