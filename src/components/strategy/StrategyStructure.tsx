...
export const StrategyStructure = () => {
  const columns = [
    {
      icon: Building2,
      title: "Structure",
      points: [
        ...
        "Ring-fenced compartments; no cross-contamination between strategies.",
        "Notes are direct, unsecured, limited-recourse obligations of the Issuer."
      ]
    },
    {
      icon: Globe,
      ...
      points: [
        ...
        "Intention to pay non-resident investors without Luxembourg withholding tax, subject to final structuring.",
    ...
    },
    {
      ...
      points: [
        "Independent board with clear separation of duties among Manager, administrator, auditor and legal counsel.",
        "Quarterly NAV and performance reports, plus audited annual financials.",
        "Transparent breakdown between Income and Equity contributions."
      ]
    }
  ];
