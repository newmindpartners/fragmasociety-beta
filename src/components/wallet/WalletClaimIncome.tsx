...
export const WalletClaimIncome = () => {
  ...
  return (
    ...
    >
      ...
      {/* Ambient light spots - soft violet pastels */}
      <div className="absolute top-0 right-1/4 w-80 h-80 bg-violet-200/40 rounded-full blur-[100px] -translate-y-1/2" />
      <div className="absolute bottom-0 left-0 w-72 h-72 bg-purple-200/30 rounded-full blur-[80px] translate-y-1/2 -translate-x-1/4" />
      <div className="absolute top-1/2 right-0 w-56 h-56 bg-indigo-200/25 rounded-full blur-[60px] translate-x-1/2" />
      ...
      <div className="relative z-10 p-7 flex flex-col h-full">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-violet-300/50 to-purple-300/50 rounded-full blur-md" />
              <div className="relative w-10 h-10 rounded-full bg-gradient-to-br from-violet-50 to-purple-50 flex items-center justify-center ring-1 ring-violet-200/60 shadow-sm">
        ...
        <div className="grid grid-cols-4 gap-3 flex-1">
          ...
          <div className="relative group">
            ...
            <div className="relative p-4 flex flex-col h-full">
              <div className="flex items-center gap-1.5 mb-2">
                <TrendingUp className="w-3.5 h-3.5 text-violet-500/80" />
          ...
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-br from-violet-50 to-purple-50/80 rounded-2xl border border-violet-200/80 shadow-sm group-hover:shadow-lg group-hover:shadow-violet-100/50 group-hover:border-violet-300/80 transition-all duration-300" />
            <div className="absolute inset-0 bg-gradient-to-br from-violet-100/20 to-purple-100/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            <div className="relative p-4 flex flex-col h-full">
              <div className="flex items-center gap-1.5 mb-2">
                <Sparkles className="w-3.5 h-3.5 text-violet-600" />
                <p className="text-[11px] text-violet-700 uppercase tracking-wider font-medium">Available to claim</p>
              </div>
        ...
        <button
          ...
          className="w-full h-14 mt-6 rounded-full bg-gradient-to-r from-violet-500 to-purple-500 hover:from-violet-400 hover:to-purple-400 flex items-center justify-center gap-3 transition-all duration-300 shadow-lg shadow-violet-500/25 hover:shadow-xl hover:shadow-violet-500/30 hover:scale-[1.02] active:scale-[0.98] group"
        >
